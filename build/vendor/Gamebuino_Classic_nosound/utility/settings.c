...
//NUM_CHANNELS is 0 for makerbuino-midi: that sketch drives the speaker
//with angyongen's Sound4 library, whose ISR(TIMER1_COMPA_vect) would
//otherwise collide with the one in this library's utility/Sound.cpp.
//Setting the channel count to 0 is this library's own way of leaving
//timer 1 and the audio pin alone (see Sound::begin).
#define NUM_CHANNELS 0 //number of sound channels, between 0 and 4
